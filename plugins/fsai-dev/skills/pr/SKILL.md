...
3. If a `pr-description` skill is available in the session, call the Skill tool with `pr-description` and follow it. It owns description quality; this phase supplies the plan and branch context.
